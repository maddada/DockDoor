...
extension Defaults.Keys {
    ...
    static let highlightActiveWindow = Key<Bool>("highlightActiveWindow", default: false)
    static let highlightActiveWindowOnlyDockDoor = Key<Bool>("highlightActiveWindowOnlyDockDoor", default: true)
    static let highlightActiveWindowUseCustomColor = Key<Bool>("highlightActiveWindowUseCustomColor", default: false)
    static let highlightActiveWindowColor = Key<Color>("highlightActiveWindowColor", default: Color.accentColor)
    ...
    static let activeAppIndicatorAutoWidth = Key<Bool>("activeAppIndicatorAutoWidth", default: false)
    ...
    static let activeAppIndicatorFadeInDuration = Key<CGFloat>("activeAppIndicatorFadeInDuration", default: 0.2)
